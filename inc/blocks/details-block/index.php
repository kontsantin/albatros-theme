...
class BlockInfo
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'info-block',
				'title'             => 'Блок: Информация об услуге',
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/info-block',wp_normalize_path(GSE()::theme_uri().$path.'/block.css'),array(),filemtime($cpath . '/block.css'));
		wp_enqueue_script('theme/info-block',wp_normalize_path(GSE()::theme_uri().$path.'/block.js'),array(),filemtime($cpath . '/block.js'));
		return;
	}
