...
class BlockAbout
{
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/about-block',wp_normalize_path(GSE()::theme_uri().$path.'/block.css'),array(),filemtime($cpath . '/block.css'));
		wp_enqueue_script('theme/about-block',wp_normalize_path(GSE()::theme_uri().$path.'/block.js'),array(),filemtime($cpath . '/block.js'));
		return;
	}
