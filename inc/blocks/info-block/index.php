...
class BlockDetails
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'details-block',
				'title'             => 'Блок: Кому подойдёт услуга (Детали)',
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/details-block',wp_normalize_path(GSE()::theme_uri().$path.'/block.css'),array(),filemtime($cpath . '/block.css'));
		wp_enqueue_script('theme/details-block',wp_normalize_path(GSE()::theme_uri().$path.'/block.js'),array(),filemtime($cpath . '/block.js'));
		return;
	}
